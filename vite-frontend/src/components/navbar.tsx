...
export const Navbar = () => {
  ...
  // Bell icon color based on critical status
          ...
          {isLoggedIn && (
            <div className="relative" ref={panelRef}>
              ...
              >
                ...
                {unreadCount > 0 && (
                  <span className={`absolute -top-0.5 -right-0.5 flex h-4 min-w-[16px] items-center justify-center rounded-full px-1 text-[10px] font-bold text-white ${criticalCount > 0 ? 'bg-red-500' : 'bg-amber-500'}`}>
