          ...
          {isLoggedIn && (
            <div className="relative" ref={panelRef}>
              ...
              >
                ...
                {unreadCount > 0 && (
                  <span className={`absolute -top-1 -right-1 flex h-[18px] min-w-[18px] items-center justify-center rounded-full px-1 text-[10px] font-bold leading-none text-white ${badgeStyles[bellTier]}`}>
