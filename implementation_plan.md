...
## 2026-03-07 Forward Console Layout Addendum

1. 把桌面端管理后台布局从“左侧栏 + 顶部条”收敛为横向头部导航，释放更多首屏空间给业务页。
2. 将“转发管理”的视图切换、导入导出、新增、搜索筛选、统计和批量动作合并到同一控制板，目标是在桌面端控制在 2-3 行内。
3. 将“网站配置”等后台配置入口移入右上角系统菜单，减少主导航噪声。
4. 为转发卡片底部测速历史补充明确的“查看详情”入口，支持查看单次测速的节点级结果，而不是只保留悬浮提示。

## 2026-03-07 CI Release Visibility Addendum
